...
func TestFileTargets(t *testing.T) {
	...
	e.nodeStateForTest = testNodeState{peers: nil}
	...
	e.nodeStateForTest = testNodeState{peers: []tailcfg.NodeView{peer.View()}}
...
func (t testNodeState) AppendMatchingPeers(peers []tailcfg.NodeView, f func(tailcfg.NodeView) bool) []tailcfg.NodeView {
